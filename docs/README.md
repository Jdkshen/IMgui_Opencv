...
> 文档同步日期：2026-08-26。这里用于区分当前使用说明、开发规范、状态快照和历史设计稿；正式运行包统一为一个固定名称。
...
4. [当前项目状态](STATUS_2026-08-26.md)：最新构建、回归、16 相机内存调度、唯一发布包和未闭环验收项。
...
- [STATUS_2026-08-26.md](STATUS_2026-08-26.md)：当前源码、按 worker 限制的任务帧复制、模型并发、YOLO 帧缓存、构建回归和发布状态。
- [STATUS_2026-08-25.md](STATUS_2026-08-25.md)：上一轮 16 槽资源调度、算法性能、启动诊断和运行包快照。
- [STATUS_2026-08-02.md](STATUS_2026-08-02.md)：独立流程图窗口、任务/工具布局、字体/图标资源、代码清理和标准 Release 构建快照。
- [STATUS_2026-08-16.md](STATUS_2026-08-16.md)：截至 2026-08-24 的构建、回归、运行包、视频 YOLO、多相机和高 DPI 状态快照。
